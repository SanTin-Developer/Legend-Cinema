    ...
    <>
      ...
      <nav className="absolute top-[20vh] mt-8 px-[32vh] py-2 ">
        <span className="gap-2">
          ...
          <Link className="text-white  ml-2">/ Privacy Policy</Link>
        </span>
        ...
        <div>
          ...
          <p className="text-white mt-5">
            ...
            To assist us in analyzing how our Service is used. <br /> We want to
            inform users of this Service that these third parties have access to
