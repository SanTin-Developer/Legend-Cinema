...
const NewsActivity = () => {
  ...
  return (
    <>
      ...
      <div className="  w-[990px] m-auto ml-[290px]  absolute top-[92vh]">
        ...
        <div className="grid grid-cols-3 mt-10 gap-3">
          <div className="w-[40vh] h-[30vh] mt-5 bg-black/15 p-2 rounded-xl border-[0.5px] border-gray-700 cursor-pointer ">
            <img
            ...
            />
            <h2 className="text-white text-[13px] font-light mt-2">
          ...
          <div className="w-[40vh] h-[30vh] mt-5 bg-black/15 p-2 rounded-xl border-[0.5px] border-gray-700 cursor-pointer ">
            <img
              ...
              alt="legend local"
              className="w-[40vh] h-[20vh] rounded-xl"
            />
            <h2 className="text-white text-[13px] font-light mt-2">
