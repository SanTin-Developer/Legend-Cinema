  ...
  return (
    <>
      ...
      <div className="absolute top-0 mt-50 w-full">
        <div className="z-[calc(var(--index)+1000)] relative  flex max-w-[990] px-70 gap-2  ">
          <Link to="/ticket">
            <span className="cursor-pointer">
              <h2 className="text-gray-400 text-3xl">Upcoming</h2>
            </span>
          </Link>
          <div className="w-0.5 bg-gray-600"></div>
          <Link to="/history">
            <span className="cursor-pointer">
              <h2 className="text-white text-3xl font-bold">History</h2>
            </span>
          </Link>
        </div>
        <span className="m-auto  flex justify-center w-full mt-30 ">
          <div>
            ...
            <h2 className="text-white ml-28 text-[15px]">No Past Tickets</h2>
          </div>
        </span>
      </div>
