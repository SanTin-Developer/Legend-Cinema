      ...
      <div className="absolute top-0 mt-50 w-full">
        <div className="z-[calc(var(--index)+1000)] relative  flex max-w-8xl px-60 gap-2  ">
          <span className="cursor-pointer">
            <h2 className="text-white text-4xl font-sans">Upcoming</h2>
          </span>
          <div className="w-0.5 bg-gray-600"></div>
          <Link to="/history">
            <span className="cursor-pointer">
              <h2 className="text-gray-400 text-4xl font-sans">History</h2>
            </span>
          </Link>
        </div>
        <span className="m-auto  flex justify-center w-full mt-30 ">
          <div>
            ...
            <h2 className="text-white ml-14 text-2xl">No Upcoming Tickets</h2>
          </div>
        </span>
      </div>
